 export const faqData = [
    {
        id: 1,
        icon: 'https://placehold.co/40x40/EC4899/FFFFFF?text=P',
        title: 'Payments',
        subtitle: 'Make & manage payments | Payment issues',
        subheadings: [
            {
                id: 'sh1-1',
                title: 'Make & manage payments',
                links: [
                    { text: 'How can I pay?', href: '#' },
                    { text: 'When is my payment due?', href: '#' },
    ...
    {
        id: 2,
        icon: 'https://placehold.co/40x40/6366F1/FFFFFF?text=S',
        title: 'Products & services',
        subtitle: 'How to use Klarna | Credit score & credit checks | Services',
        subheadings: [
             {
                id: 'sh2-1',
    ...
    {
        id: 3,
        icon: 'https://placehold.co/40x40/14B8A6/FFFFFF?text=R',
        title: 'Refunds',
        subtitle: 'Manage refunds',
        subheadings: [
            {
                id: 'sh3-1',
    ...
    {
        id: 4,
        icon: 'https://placehold.co/40x40/F59E0B/FFFFFF?text=B',
        title: 'Klarna balance',
        subtitle: 'Klarna Debit Flex Card | Klarna balance',
        subheadings: [
            {
                id: 'sh4-1',
    ...
    {
        id: 5,
        icon: 'https://placehold.co/40x40/F43F5E/FFFFFF?text=D',
        title: 'Delivery & returns',
        subtitle: 'Deliveries | Returns | Cancellations',
        subheadings: [
            {
                id: 'sh5-1',
    ...
    {
        id: 6,
        icon: 'https://placehold.co/40x40/06B6D4/FFFFFF?text=F',
        title: 'Fraud & security',
        subtitle: 'Report fraud | Prevent fraud | Data protection',
        subheadings: [
            {
                id: 'sh6-1',
                title: 'Fraud & Security',
    ...
    {
        id: 7,
        icon: 'https://placehold.co/40x40/EF4444/FFFFFF?text=X',
        title: 'Declined purchase',
        subtitle: 'Declined Purchase',
        subheadings: [
            {
                id: 'sh7-1',
                title: 'Declined Purchase',
    ...
    // {
    //     id: 9,
    //     icon: 'https://placehold.co/40x40/3B82F6/FFFFFF?text=M',
    //     title: 'Klarna Mobile',
    //     subtitle: 'Getting Started | eSIM | Coverage & Service',
    //     subheadings: [
    //         {
    //             id: 'sh9-1',
